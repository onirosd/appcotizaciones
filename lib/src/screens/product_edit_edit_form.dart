...
/*        valmin = double.parse((double.parse(selectedProducts.numPriceMin) -
  ...
  void _calculamosSubTotal(int catProd, double minval, double maxval) {
    final result = ProductSubtotalHelper.calcular(
      ...
      diametro: double.parse(diameterController.text),
      interno: double.parse(internoController.text),
      longitud: double.parse(longController.text),
      cantidad: double.parse(amountController.text),
      empaque: int.parse(empaqueController.text),
      precioTexto: priceController.text,
      precioMinimo: minval,
      precioMaximo: maxval,
      igv: double.parse(ListItemsEdit.listIgv[0]),
    );
